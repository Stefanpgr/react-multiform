...
const Form2 = ({ next, prev, employment, sendApplication }) => {
		...
		>
			<Form.Item name={[ 'employment_type' ]} label="What's your employment type?" rules={[ { required: true } ]}>
				<Select size="large" style={{ width: '58%' }} placeholder="Select your employment type">
					<Select.Option value="Employed">Salaried employment</Select.Option>
			...
			<Form.Item name={[ 'company_address' ]} label="Address of the company" rules={[ { required: true } ]}>
				<Input style={{ width: '58%' }} placeholder="Enter the company address" size="large" />
			</Form.Item>
...
export default connect(mapStateToProps, { sendApplication })(Form2);
