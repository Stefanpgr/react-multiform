...
const Documents = () => {
  ...
  const docs = [
    { title: "Employment Letter", percent: percent },
    { title: "Driver’s license", percent: percent2 },
    { title: "Company ID card", percent: percent3 },
    { title: "Passport Photo", percent: percent4 },
  ];
                    ...
                    <Row className="pl-2">
                      ...
                      >
                        ...
                        <div className="pt-2 pl-2">
                          ...
                          {progress ? (
                            <Progress percent={el.percent} status="active" />
                          ) : (
                            ""
                          )}
                        </div>
                        ...
                        <div className="ml-4 mt-3">
                          <Btn onClick={() => handleClick()}>
                            <input
                              style={{ display: "none" }}
                              type="file"
                              onChange={(e) => handleFileChange(e, el.title)}
                              ref={fileInput}
                            />
                            <UploadOutlined
                              className="mr-2"
