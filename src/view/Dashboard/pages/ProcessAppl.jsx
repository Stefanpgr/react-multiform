    ...
    <div className="row">
      <div className="text-center col  mt-2 pt-5">
        ...
        <h6 style={{ color: "#00204F", fontSize: "12px" }}>
          <strong>Your application is currently being processed.</strong> We
          will get back to you shortly. Check back here or look out for an email
          from us in your inbox or spam.
        </h6>
        <h6 style={{ color: "#00204F", fontSize: "12px" }}>
          {" "}
